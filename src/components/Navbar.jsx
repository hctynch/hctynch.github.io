...
const projects = [
  {
    ...
    description: [
      'Created this personal portfolio using React, Vite, and TailwindCSS.',
      'Utilizes github actions to redeploy updated build to github pages upon commit.',
    ],
    tools: 'React, Vite, TailwindCSS, Github, Github Actions',
    href: 'https://github.com/hctynch/hctynch.github.io',
  },
  {
    title: 'Foxhound Scoring Software',
    description: [
      'Created an updated score tracking software for foxhound field trials.',
      'Stores dog crosses and information throughout the hunt, and displays point totals as well as other various details.',
    ],
    tools: 'Java, Spring Boot, Docker, MySQL, React',
    href: 'https://github.com/hctynch/mastersgtp',
  },
  {
    title: 'Upcoming Project (ML Routing System)',
    description: [],
    tools: '...',
    href: '#',
  },
...
export default function Example() {
  ...
  const handleScroll = () => {
    ...
    const closestIndex = sectionRefs.current.reduce(
  ...
  useEffect(() => {
    setTimeout(() => setIsLoading(false), 2200); // Simulate loading
  }, []);

  return (
    <>
      {isLoading ? (
        <LoadingAnimation text='Huunt Tynch' />
      ) : (
        <div className='max-h-max'>
          ...
          <div className='relative isolate px-6 pt-14 lg:px-8'>
            ...
            <div className='flex flex-col font-source items-end mx-20 -my-32 min-w-60 sm:mx-0 sm:max-w-full sm:items-center'>
              ...
              <FadeSection>
                <div
                  className='sm:max-w-2xl py-32 sm:py-44 transform transition-opacity opacity-100'
                  id='home'
              ...
              <FadeSection>
                <div
                  className='max-w-60 md:max-w-2xl -my-8 sm:-my-0 sm:py-44'
                  id='about'
                  href='#about'
                  ...
                  <div className='flex flex-col text-start sm:justify-center sm:text-center sm:items-center'>
                    ...
                    <p className='mt-4 text-balance sm:text-center text-md font-medium light:text-gray-500 dark:text-gray-400 sm:text-xl/8'>
                      Hi, I’m Hunt Tynch; A Software Engineer passionate about
                      backend development and building robust, scalable systems.
                      With expertise in Java, C, and frameworks like Spring, I
                      specialize in creating efficient APIs, data-driven
                      applications, and server-side solutions that power
                      seamless user experiences. I earned my Bachelor’s in
                      Computer Science from NC State University, where I honed
                      my skills in software design, algorithms, and system
                      architecture. My academic projects and hands-on experience
                      have deepened my understanding of creating clean,
                      maintainable code for real-world applications. When I’m
                      not solving coding challenges, I enjoy gaming and playing
                      basketball, which keeps me energized and focused. I’m
                      always excited to collaborate, tackle new technologies,
                      and deliver impactful software solutions. Check out my
                      projects below or reach out to start a conversation—I’d
                      love to connect!
                    </p>
                  </div>
                </div>
              ...
              <FadeSection>
                <div
                  className='max-w-60 sm:max-w-2xl my-32 sm:-my-0 sm:py-44'
                  id='skills'
                  href='#skills'
              ...
              <FadeSection>
                <div
                  className='max-w-60 sm:max-w-2xl sm:-my-0 sm:py-44'
                  id='projects'
                  href='#projects'
